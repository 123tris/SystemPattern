...
namespace Utility
{
    internal static class CooldownManager
    {
        ...
        private static readonly Dictionary<string, Coroutine> coroutines = new Dictionary<string, Coroutine>();
        ...
        public static Coroutine Cooldown<T, U, X>(float cooldownDuration, Action<T, U, X> action, T param1, U param2,
            X param3)
        {
        ...
        private static IEnumerator InternalCooldown<T, U>(float cooldownDuration, Action<T, U> action, T parameter1,
            U parameter2)
        {
            yield return new WaitForSeconds(cooldownDuration);
        ...
        private static IEnumerator InternalCooldown<T, U, X>(float cooldownDuration, Action<T, U, X> action,
            T parameter1, U parameter2, X parameter3)
        {
            yield return new WaitForSeconds(cooldownDuration);
